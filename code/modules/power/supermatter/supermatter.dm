...
/obj/machinery/power/supermatter/attack_hand(mob/living/user as mob)
	if(!istype(user))
		return
...
/obj/machinery/power/supermatter/attackby(obj/item/W as obj, mob/living/user as mob, params)
